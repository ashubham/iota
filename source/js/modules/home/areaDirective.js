define(['angular','jquery','d3', './module'], function (angular, $, d3, module) {
  ...
  return module.directive('fsArea', [function() {
      'use strict';
      ...
      return {
          ...
          link: function(scope, element, attrs) {
              ...
              var line = d3.svg.line()
                  ...
                  .y(function(d) { return y((stat) ? d['stats'][stat]: d.doc_count); });

              // create area generator
              var area = d3.svg.area()
                  .x(function(d) { return x(d.key); })
                  .y0(height)
                  .y1(function(d) { return y((stat) ? d['stats'][stat]: d.doc_count); });
                      ...
                      if (dataPoints == 'true') {
                          ...
                          var points = svg.selectAll('circle')
                              .data(data.filter(function(d) {
                                  return (stat) ? d['stats'][stat]: d.doc_count;
                              }), function(d) {
                                  return Math.random();
                              });
