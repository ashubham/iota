...
define(['angular','jquery','d3', './module'], function (angular, $, d3, module) {
    ...
    return module.directive('fsDonut', [function() {
        'use strict';
            ...
            link: function(scope, element, attrs) {
                ...
                scope.$watch('bind', function(data) {
                    ...
                    if (data) {
                        ...
                        // pull out the buckets array from the agg
                        data = data.buckets || [];
                            ...
                            path.enter()
                                ...
                                .on('mousedown', function(d) {
                                    scope.$apply(function() {
                                        (scope.onClick || angular.noop)(attrs.field, d.data.key);
                                    });
                                });
